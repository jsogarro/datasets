...
where
  ...
  * `f` is a [file symbol](../../basics/glossary/#file-symbol)
  * `o` is an offset as a non-negative integer/long
  * `h` is a [system or connection handle](../../basics/handles/)
  * `fifo` is a communication handle to a [Fifo](../hopen/#communication-handles)
...
[Connection handles](../../basics/handles/), [File system](../../basics/files/),q4m [Interprocess communication](../../basics/ipc/)   


_Q for Mortals_ [§11.4.1 Reading and Writing Text Files](/q4m3/11_IO/#1141-reading-and-writing-text-files)
