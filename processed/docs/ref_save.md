...
There are no corresponding formats for [`load`](../load/). Instead, use [File Text](../file-text/).

[.h](../doth/) (data serialization tools)
...
The usual and more general way of doing this is to use [`set`](../get/#set), which allows the target directory to be specified.
...
[`set`](../get/#set), [`.h.tx`](../doth/#htx-filetypes), [`.Q.dpft`](../dotq/#chk-fill-hdb) (save table), [`.Q.Xf`](../dotq/#xf-create-file) (create file)   


[File system](../../basics/files/)   


_Q for Mortals_q4m [§11.2 Save and Load on Tables](/q4m3/11_IO/#112-save-and-load-on-tables)   


_Q for Mortals_q4m [§11.3 Splayed Tables](/q4m3/11_IO/#113-splayed-tables)
