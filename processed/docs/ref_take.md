...
`#` is a [multithreaded primitive](../../kb/mt-primitives/).
...
Prefect    126 25
```
Not currently supported for partitioned tables. [`.Q.ind`](../dotq/#ind-partitioned-index) can be used as an alternative to access indices.
...
Prefect    25
```
Not currently supported for partitioned tables.
