...
There are no text formats corresponding to [`save`](../save/). Instead, use [File Text](../file-text/).
...
rload x     rload[x]
```
Where `x` is the table name as a symbol, the table is read from a directory of the same name. `rload` is the converse of [`rsave`](../save/#rsave).

The usual, and more general, way of doing this is to use [`get`](../get/), which allows a table to be defined with a different name than the source directory.
...
[`save`, `rsave`](../save/)  
[`.Q.dsftg`](../dotq/#dsftg-load-process-save) (load process save), [`.Q.fps`](../dotq/#fps-pipe-streaming) (pipe streaming), [`.Q.fs`](../dotq/#fs-file-streaming) (file streaming), [`.Q.fsn`](../dotq/#fsn-file-streaming) (file streaming with chunks), [`.Q.v`](../dotq/#v-value) (get splayed table)   


[File system](../../basics/files/)   


_Q for Mortals_ [§11.2 Save and Load on Tables](/q4m3/11_IO/#112-save-and-load-on-tables)
