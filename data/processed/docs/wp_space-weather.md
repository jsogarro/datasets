  ...
  * kdb+ and q  kdb+ and q 
    ...
    * Learn  Learn 
      ...
      * Application examples  Application examples 
        ...
        * Space weather  [ Space weather ](./) On this page 
...
NASA FDL 2018 focused on four areas of research â Space Resources, Exoplanets, Space Weather and Astrobiology â each with their own separate challenges. This paper will focus on the first of the Space Weather challenges, which aimed to forecast Global Navigation Satellite System (GNSS) disruptions.

## The Space Weather Challenge¶

A GNSS is a network of satellites providing geospatial positioning with global coverage. The most famous example is the United Statesâ Global Positioning System (GPS). Such a network relies upon radio communications between satellites and ground-based receivers, which can be subject to interruptions in the presence of extreme space weather events.

_Space weather_ refers to changes in radiation emitted by the Sun, leading to fluctuations in the Earthâs ionosphere. Changes to the electron density in the ionosphere cause fluctuations in the amplitude and phase of radio signals, referred to as phase scintillation. Radio signals propagating between GNSS satellites and ground-based receivers are affected by these scintillation events and can become inaccurate or even lost. 
...
As only 3% of the data represented scintillation occurring, it would have been easy to create a model which produced high accuracy. A naÃ¯ve model which predicted that scintillation never occurred would still have been correct 97% of the time. Additional metrics were therefore needed to determine how well the models performed. 
...
_Figure 2: True Skill Statistic results produced by the Support Vector Machine models (individual models â left, Fort McMurray model â right). The combined and Fort McMurray models are plotted in black._
...
_Figure 5: The variation in the phase scintillation index (sigPhiVer), the differential Total Electron Content (dtec) and the X component of the Earthâs magnetic field during a scintillation event, where sigPhiVer is greater than 0.1 radians._
...
Target data was log scaled to prevent negative predictions for σφ, which is always positive. A train-test split of 80%/20% was again used.
...
_Figure 9: True Skill Statistic results for the neural network model, predicting 30 minutes â 24 hours ahead for the combined (ALL), Fort Churchill (chu), Fort Simpson (fsi) and Fort McMurray (mcm) models._
...
_Figure 10: Accuracy results for the neural network model, predicting 30 minutes â 24 hours ahead for the combined (ALL), Fort Churchill (chu), Fort Simpson (fsi) and Fort McMurray (mcm) models._
...
[6] Kintner, P., Ledvina, B. and de Paula, E. âGPS and ionospheric scintillationsâ, _Space Weather_ , 5(9), 2007.

[7] Tinin, M. and I.Knizhin, S. âEliminating the Effects of Multipath Signal Propagation in a Smoothly Inhomogeneous Mediumâ, _Radiophysics and Quantum Electronics_ , 56(7), pp.413-421, 2013.
...
[9] Jin, Y., Miloch, W. J., Moen, J. I. and Clausen, L. B. âSolar cycle and seasonal variations of the GPS phase scintillation at high latitudesâ, _Journal of Space Weather and Space Climate_ , 8, p.A48., 2018.
...
I gratefully acknowledge the Space Weather 1 team at FDL â Danny Kumar, Karthik Venkataramani, Kibrom Ebuy Abraha and Laura Hayes â for their contributions and support.
