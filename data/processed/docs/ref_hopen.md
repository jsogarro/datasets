...
kdb+ communicates with the [file system](../../basics/files/) and other processes through

  * one-shot functions
  * [handles](../../basics/handles/) to persistent connections
...
```
User and password are required if the server session has been started with the [`-u`](../../basics/cmdline/#-u-usr-pwd-local) or [`-U`](../../basics/cmdline/#-u-usr-pwd) command line options, and are passed to [`.z.pw`](../dotz/#zpw-validate-user) for (optional) additional processing.
...
[`.Q.Xf`](../dotq/#xf-create-file) (create file)   


[Communication handle](../../basics/glossary/#communication-handle), [Connection handle](../../basics/glossary/#connection-handle), [File system](../../basics/files/), [Interprocess communication](../../basics/ipc/)   


[Named pipes](../../kb/named-pipes/), [SSL/TLS](../../kb/ssl/)   


_Q for Mortals_ [§11.8.2 Opening a Connection Handle](/q4m3/11_IO/#1162-opening-a-connection-handle)
