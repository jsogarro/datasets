...
```
`max` is a [multithreaded primitive](../../kb/mt-primitives/).
...
`max`, `maxs`, and `mmax` apply to [dictionaries and tables](../../basics/math/#dictionaries-and-tables).
...
[Comparison](../../basics/comparison/), [Mathematics](../../basics/math/)   
