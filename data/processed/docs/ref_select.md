# select keyword, Select operator
...
For the Select operator `?`, see [Functional SQL](../../basics/funsql/)
...
- **Lexp** Limit expression
- **ps** Select phrase
- **pb** By phrase
- **texp** Table expression
- **pw** Where phrase

See [qSQL syntax](../../basics/qsql/)
...
To limit the returned results you can include a limit expression _Lexp_
...
See [The SQL `GROUP BY` statement](https://www.w3schools.com/sql/sql_groupby.asp)

The [`ungroup`](../ungroup/) keyword reverses the grouping, though the original order is lost.
...
Cond is not supported inside query templates: see [qSQL](../../basics/qsql/#cond).

---

**See Also:** [`delete`](../delete/), [`exec`](../exec/), [`update`](../update/), [qSQL](../../basics/qsql/), [Functional SQL](../../basics/funsql/), _Q for Mortals_ §9.3 The `select` Template
